---
title: "转linux 系统 UDP 丢包问题分析思路"
date: 2023-09-13T21:37:56+08:00
lastmod: 2023-09-13T22:37:56+08:00
draft: false
tags: ["udp", "丢包"]
categories: ["笔记"]
author: "dcq"
...
[linux 系统 UDP 丢包问题分析思路_ArthurKingYs的博客-CSDN博客](https://blog.csdn.net/u011001084/article/details/79093393)
...
如果硬件或者驱动没有问题，一般网卡丢包是因为设置的缓存区（ring [buffer](https://so.csdn.net/so/search?q=buffer&spm=1001.2101.3001.7020)）太小，可以使用`ethtool` 命令查看和设置网卡的 ring buffer。
